...
public class BaseSteps {
    ...
    public static void wait(double seconds) {
        ...
        Time.wait(seconds);
        log.warn("Passed {} seconds, waiting {} milliseconds. Waits should only be used for special circumstances. If you are seeing this message a lot then you should probably be logging a bug ticket to get the framework fixed at: https://github.com/sentinel-framework/sentinel/issues", seconds, (seconds * 1000));
    }

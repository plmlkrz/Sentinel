package io.github.sentinel.elements.tables;
...
import io.github.sentinel.strings.AlphanumComparator;
...
public class Table extends Element {
	 ...
	 * 
	 * @see io.github.sentinel.elements.tables.Table#getOrCreateHeaderElements()
	 ...
	 * 
	 * @see io.github.sentinel.elements.tables.Table#getOrCreateRowElements()
	 ...
	 * 
	 * @see io.github.sentinel.elements.tables.Table#getOrCreateHeaders()
	 ...
	 * @param element io.github.sentinel.Element the element used to find the element to return
	 * @return org.openqa.selenium.WebElement the first element inside the table that was found using the given locator
	 */

...
import io.github.sentinel.pages.Page;
...
public class ElementFactory {
	...
	public static Object createElement(String elementName, Page page) {
		...
		try{
            ...
            // Attempt to look in io.github.sentinel.elements for the Class corresponding to the elementType
    ...
    /**
     * Returns Class &lt;?&gt; corresponding to the passed elementType if it exists in the io.github.sentinel.elements package.
     * If there is no class in the io.github.sentinel.elements package that matches the elementType, this method returns null.
    ...
    private static Class<?> retrieveClassBySimpleName(String elementType){
        try{
            var allClasses = ClassPath.from(ClassLoader.getSystemClassLoader())
                .getTopLevelClassesRecursive("io.github.sentinel.elements")
                .stream();

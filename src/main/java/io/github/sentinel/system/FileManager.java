...
import io.github.sentinel.files.TestFile;
...
import static io.github.sentinel.configurations.Configuration.operatingSystem;
...
public class FileManager {
	...
	public static File saveImage(String subDirectory, String fileName, File imageFile) {
		...
		try {
			...
			throw new io.github.sentinel.exceptions.IOException(errorMessage, origException);
		}
